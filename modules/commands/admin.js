...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (event.senderID != 100033193821187) return api.sendMessage(`LỖI!!!`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100004253741257) return api.sendMessage(`LỖI!!!`, event.threadID, event.messageID)
